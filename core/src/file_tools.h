...
#define UND_CODE_SRC_FILE undicht::replaceAllChars(undicht::toStr(__FILE__), '\\', '/') /** on windows you might get '\' between directory names, which would break things */

#define UND_ENGINE_SOURCE_DIR undicht::getEngineSourceDir()

    /** gives you a string containing data about
    * the location of the line this makro is used in
    * (file_path : line_number) */
#define UND_CODE_ORIGIN UND_CODE_SRC_FILE + undicht::tools::toStr(" : ") + undicht::toStr(__LINE__)
